  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                '<div class="date-range-title">Select Start Date for Custom Range</div><div class="calendar left"></div>' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<div class="dropdown-footer"><button class="applyBtn" disabled="disabled"></button>&nbsp;' +
